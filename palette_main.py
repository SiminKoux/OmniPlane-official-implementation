...
def train(args):
    ...
    # if args.use_palette:
    #     # freeze parameters for density regressing
    ...
    for iteration in pbar:
        ...
        # if iteration >= args.max_freeze_palette_iters:
        #     model.freeze_basis_color = True
        #     palette_lambda = 0
        #     hsv_reg_lambda = 0
        #     # omega_sparsity_lambda = args.omega_sparsity_lambda
        #     # offset_norm_lambda = args.offset_norm_lambda
    ...
    if args.render_test:
        ...
        PSNRs_test = evaluation(
            ...
            N_vis=-1, n_coarse=n_coarse,
            n_fine=n_fine, device=device, 
            exp_sampling=args.exp_sampling,
            empty_gpu_cache=True, 
            resampling=args.resampling, 
            use_coarse_sample=use_coarse_sample,
